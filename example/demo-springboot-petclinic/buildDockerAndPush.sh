...
if [ -z ${image_version} ]; then
 ...
 echo push adopteunops/demo-petclinic:${image_version}
 docker push adopteunops/demo-petclinic:${image_version}
 echo adopteunops/demo-petclinic:${image_version} is pushed
