<template>
  <v-container fluid grid-list-md >
      ...
      <v-layout row >
            <v-text-field v-show="viewText" name="Raw Data" label="Raw Data" textarea dark v-model="textRawData"></v-text-field>
      </v-layout>
      <v-layout row>
      ...
      <v-layout row>
          <v-btn color="blue-grey lighten-3" small>{{messageActive}}</v-btn>
